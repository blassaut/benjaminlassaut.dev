    ...
    <section data-testid="intro-section" className="relative min-h-screen flex items-center justify-center px-6">
      ...
      <div className="relative z-10 max-w-4xl text-center">
        ...
        >
          ...
          <span className="sr-only"> - Lead QA Engineer / SDET | Test Automation & Quality Engineering</span>
        </motion.h1>
      ...
      <FloatingTag text="Playwright" x="85%" y="30%" delay={1.4} />
      <FloatingTag text="BDD / Cucumber" x="5%" y="70%" delay={1.8} />
      <FloatingTag text="CI/CD" x="88%" y="65%" delay={2.2} />
    </section>
  )
}
